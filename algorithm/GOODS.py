...
if __name__ == '__main__':
    ...
    brand = ["CHANEL", "VERICE", "PARADA", "GUCCI", "HERMES", "Armani", "Versace"]
    ...
    for i in range(0, len(df["image_name"])):
        ...
        if path_s[4].split("_")[2] == "full.jpg".lower():
            ...
            good.path = data_set_path + path  # 数据库里存的是 文件绝对地址
            good.price = random.randrange(100, 5000)
            good.brand = random.randint(0, 7)
            # 根据需要替换一下吧
            good.descr = "<div><h4>摇滚女神的热情似火</h4>此款衣服的最大亮点在于三套式穿法 ，外套，马甲，连衣裙 " \
